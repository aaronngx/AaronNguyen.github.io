...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-lBtqcka9.js")
  },
  {
    name: "app",
    path: "/app",
    component: () => import("./_nuxt/app-NTPEXh4h.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-wxBuizLe.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-QJVUd3HC.js")
  },
  {
    name: "multiplication-game",
    path: "/multiplication-game",
    component: () => import("./_nuxt/multiplication-game-B81JZqH5.js")
  },
  {
    name: "snake-game",
    path: "/snake-game",
    component: () => import("./_nuxt/snake-game-fmAG0uX4.js")
  },
  {
    name: "todo-list-app",
    path: "/todo-list-app",
    component: () => import("./_nuxt/todo-list-app-0sI1jpb0.js")
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-Bf21HNV5.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CGLei8B3.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C00D4Cfm.js"));
